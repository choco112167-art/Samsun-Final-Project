...
export default function ArticleCard({ article, bookmarked = false, onBookmark, onClick, style }: Props) {
  ...
  // summaryKobart 우선, 없으면 summaryLlm
  const summary = article.summaryKobart || article.summaryLlm;
  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginBottom: 8, paddingLeft: 8 }}>
        <div style={{ width: 6, height: 6, borderRadius: '50%', background: article.sourceColor, flexShrink: 0 }} />
